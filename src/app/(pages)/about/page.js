  ...
  return (
    <>
      ...
      <section className="pt30 pb-0">
        <div className="cta-banner3 about-box2 mx-auto maxw1600 pt100 pt60-lg pb90 pb60-lg bdrs24 position-relative overflow-hidden mx20-lg">
          <div className="container">
            <div className="row">
              <div
              ...
              >
                <div className="mb30">
                  <h2 className="title text-capitalize">
                    ...
                    selling option for youuuuu
                  </h2>
                </div>
                <div className="why-chose-list style2">
                  <Features />
                </div>
                <Link href="#" className="ud-btn btn" style={{background: "white"}}>
                  Learn More
